...
\newglossaryentry{ndcgatk} {
    ...
    text=NDCG@\emph{k},
    sort=ndcg,
    description={Normalized Discounted Cumulative Gain@\emph{k}, metrica di valutazione per sistemi di ranking che misura la qualità di una lista ordinata considerando sia la rilevanza degli elementi sia la loro posizione. Il DCG viene normalizzato dal DCG ideale per permettere confronti tra query diverse}
}
