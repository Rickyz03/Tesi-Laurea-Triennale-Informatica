...
\begin{table}[h!]
    ...
    \rowcolor{gray!75}
    \textbf{Requisito} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
    ROQ-1 & Il lavoro svolto deve essere opportunamente documentato. & Azienda, ... \\ \hline
    ROQ-2 & Il codice prodotto deve essere completamente coperto da test di unità. & Azienda, ... \\ \hline
    ROQ-3 & La task di raccomandazione di prodotti e clienti deve produrre un risultato in tempi ragionevoli. & Azienda, ... \\ \hline
    ROQ-4 & Le risposte prodotte dall'LLM devono essere testate, dopo aver definito un opportuno metodo di test. & Azienda, ... \\ \hline
    \end{tabularx}
...
\begin{table}[h!]
    ...
    \rowcolor{gray!75}
    \textbf{Requisito} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
    ROV-1 & Le funzionalità devono essere espresse mediante due task create usando la piattaforma Oribea. & Azienda, ... \\ \hline
    ROV-2 & I due progetti software delle due tasks devono essere inseriti nel campo function della schermata di creazione task della piattaforma Oribea. & Azienda, ... \\ \hline
    ...
    ROV-4 & Le due task devono utilizzare, come archiviazione, il profilo Google Cloud dell'azienda Oribea. & Azienda, ... \\ \hline
    \end{tabularx}
