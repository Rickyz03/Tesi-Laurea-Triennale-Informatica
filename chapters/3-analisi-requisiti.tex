...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC17 - Inserimento del nome del file CSV degli ordini originale.png}
...
\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC21 - Inserimento nome elemento per cui raccomandare.png}
