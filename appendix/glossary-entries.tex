...
\newacronym[description={\glslink{gcsfs}{Google Cloud Storage File System}}]
    {gcsfs_acr}{GCSFS}{Google Cloud Storage File System}
...
\newglossaryentry{googlecloudplatform} {
...
\newglossaryentry{macchinaproduzione} {
    name=Macchina di produzione,
    text=macchina di produzione,
    sort=macchinaproduzione,
    description={ambiente di produzione dove vengono eseguiti i sistemi software accessibili agli utenti finali, caratterizzato da alta disponibilità, sicurezza e stabilità, opposto alla \gls{macchinadev} utilizzata per lo sviluppo}
}
...
\newglossaryentry{google.cloud.storage} {
    name=google.cloud.storage,
    text=google.cloud.storage,
    sort=googlecloudstorage,
    description={libreria ufficiale di Google per interagire con Google Cloud Storage, che consente di gestire bucket, caricare e scaricare file, e gestire i permessi di accesso ai file. È caratterizzata da completezza funzionale e supporto ufficiale di Google}
}

\newglossaryentry{gcsfs} {
    name=\glslink{gcsfs_acr}{gcsfs},
    text=gcsfs,
    sort=gcsfs,
    description={libreria che fornisce un file system virtuale per Google Cloud Storage, consentendo di interagire con i bucket come se fossero normali directory locali. È caratterizzata da facilità d'uso e integrazione con Pandas e NumPy per operazioni di lettura e scrittura dirette su Google Cloud Storage}
}

\newglossaryentry{data-reduction} {
    name=Data Reduction,
    text=Data Reduction,
    sort=datareduction,
    description={processo di riduzione della dimensionalità, del volume o della complessità dei dati mantenendo le informazioni più significative, attraverso tecniche come campionamento, aggregazione, compressione o selezione delle caratteristiche più rilevanti}
}
...
\newglossaryentry{kaggle} {
    ...
    text=Kaggle,
    sort=kaggle,
    description={piattaforma online per competizioni di data science e machine learning, che ospita dataset, notebook e una comunità di data scientist per condividere conoscenze e soluzioni}
}
