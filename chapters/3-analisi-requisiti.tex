...
\hypertarget{UC19}{}
\begin{usecase}{19}{Inserimento del nome del file CSV degli ordini originale}

\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC19 - Inserimento nome CSV degli ordini originale.png}
    \caption{UC19 - Inserimento del nome del file CSV degli ordini originale}
\end{figure}
...
\hypertarget{UC23}{}
\begin{usecase}{23}{Inserimento nome elemento per cui raccomandare}

\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC23 - Inserimento nome elemento a cui raccomandare.png}
    \caption{UC23 - Inserimento nome elemento per cui raccomandare}
\end{figure}
...
\hypertarget{UC24}{}
\begin{usecase}{24}{Selezione lingua per la raccomandazione}

\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC24 - Selezione lingua per la raccomandazione.png}
    \caption{UC24 - Selezione lingua per la raccomandazione}
\end{figure}
...
\usecasepost{Il sistema ha memorizzato la lingua selezionata}
\usespecial{UC25, UC26, UC27, UC28, UC29}
\label{uc:selezione-lingua-raccomandazione}
\end{usecase}


\hypertarget{UC25}{}
\begin{usecase}{25}{Selezione lingua italiano per la raccomandazione}
...
\hypertarget{UC26}{}
\begin{usecase}{26}{Selezione lingua inglese per la raccomandazione}
...
\hypertarget{UC27}{}
\begin{usecase}{27}{Selezione lingua francese per la raccomandazione}
...
\hypertarget{UC28}{}
\begin{usecase}{28}{Selezione lingua spagnolo per la raccomandazione}
...
\hypertarget{UC29}{}
\begin{usecase}{29}{Selezione lingua tedesco per la raccomandazione}
...
\hypertarget{UC30}{}
\begin{usecase}{30}{Visualizzazione classifica elementi raccomandati}

\begin{figure}[!h]
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC30 - Visualizzazione classifica elementi raccomandati.png}
    \caption{UC30 - Visualizzazione classifica elementi raccomandati}
\end{figure}
...
\usecasealt{UC31}
\usespecial{UC32, UC33}
\label{uc:visualizzazione-classifica-elementi-raccomandati}
\end{usecase}


\hypertarget{UC31}{}
\begin{usecase}{31}{Visualizzazione errore di elaborazione della task}
...
\hypertarget{UC32}{}
\begin{usecase}{32}{Visualizzazione classifica prodotti raccomandati}
...
\hypertarget{UC33}{}
\begin{usecase}{33}{Visualizzazione classifica clienti raccomandati}
...
ROF-6 & Nel caso avvenga un imprevisto, il sistema deve permettere all'utente di visualizzare un messaggio che segnala un errore di elaborazione della task. & \hyperlink{UC14}{UC14} \\ \hline
ROF-7 & Il sistema deve permettere all'utente di scaricare il report generato dalla task di analisi delle vendite, in formato PDF. & \hyperlink{UC15}{UC15}, \hyperlink{UC16}{UC16}\\ \hline
RDF-8 & Il sistema deve permettere all'utente di scaricare il report generato dalla task di analisi delle vendite, in formato HTML. & \hyperlink{UC15}{UC15}, \hyperlink{UC17}{UC17} \\ \hline
RZF-9 & Il sistema deve inviare il report generato dalla task di analisi delle vendite all'indirizzo email inserito dall'utente. Il testo della mail deve contenere l'HTML del report, e i file PDF e HTML devono essere inviati in allegato. & \hyperlink{UC18}{UC18} \\ \hline
ROF-10 & Nel report delle vendite generato, l'utente deve visualizzare alcuni dati numerici legati alle vendite. & Azienda, \hyperlink{18.1}, \hyperlink{UC18.1.1}{UC18.1.1}, \hyperlink{UC18.1.2}{UC18.1.2}, \hyperlink{UC18.1.3}{UC18.1.3}, \hyperlink{UC18.1.4}{UC18.1.4} e \hyperlink{UC18.1.5}{UC18.1.5} \\ \hline
ROF-11 & Nel report delle vendite generato, l'utente deve visualizzare alcuni grafici generati a partire dai dati delle vendite. & Azienda, \hyperlink{UC18.2}{UC18.2}, \hyperlink{UC18.2.1}{UC18.2.1}, \hyperlink{UC18.2.2}{UC18.2.2}, \hyperlink{UC18.2.3}{UC18.2.3}, \hyperlink{UC18.2.4}{UC18.2.4}, \hyperlink{UC18.2.5}{UC18.2.5}, \hyperlink{UC18.2.6}{UC18.2.6} e \hyperlink{UC18.2.7}{UC18.2.7} \\ \hline
ROF-12 & Nel report delle vendite generato, l'utente deve visualizzare un resoconto dell'analisi delle vendite, generato dall'LLM. & Azienda, \hyperlink{UC18.3}{UC18.3} \\ \hline
ROF-13 & Il sistema deve permettere all'utente di inserire il nome del file CSV degli ordini originale, che era stato caricato nella task di analisi delle vendite. & \hyperlink{UC19}{UC19} \\ \hline
ROF-14 & Il sistema deve permettere all'utente di selezionare il tipo di raccomandazione da svolgere, tra "raccomandare prodotti per un cliente" e "raccomandare clienti per un prodotto". & \hyperlink{UC20}{UC20}, \hyperlink{UC21}{UC21} e \hyperlink{UC22}{UC22} \\ \hline
ROF-15 & Il sistema deve permettere all'utente di inserire il nome dell'elemento per cui desidera che venga eseguita la raccomandazione. & \hyperlink{UC23}{UC23} \\ \hline
ROF-16 & Il sistema deve permettere all'utente di selezionare la lingua da usare per generare la raccomandazione, tra italiano, inglese, francese, spagnolo e tedesco. & \hyperlink{UC24}{UC24}, \hyperlink{UC25}{UC25}, \hyperlink{UC26}{UC26}, \hyperlink{UC27}{UC27}, \hyperlink{UC28}{UC28} e \hyperlink{UC29}{UC29} \\ \hline
ROF-17 & Nel caso la task di raccomandazione sia stata eseguita correttamente, , il sistema deve permettere all'utente di visualizzare la classifica degli elementi raccomandati. & \hyperlink{UC30}{UC30}, \hyperlink{UC32}{UC32} e \hyperlink{UC33}{UC33} \\ \hline
ROF-18 & Nel caso avvenga un imprevisto, il sistema deve permettere all'utente di visualizzare un messaggio che segnala un errore di elaborazione della task. & \hyperlink{UC31}{UC31} \\ \hline
