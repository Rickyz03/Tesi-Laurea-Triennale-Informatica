...
\begin{risk}{Cambiamento dei requisiti in corso di sviluppo}
    \riskdescription{i requisiti del progetto potrebbero cambiare durante lo sviluppo dello
stesso. Alcuni dei motivi potrebbero essere delle modifiche alle esigenze del progetto, un errore di analisi iniziale oppure motivi legati alle tecnologie scelte}
...
\begin{risk}{Inesperienza tecnologica}
    \riskdescription{il progetto prevede l’utilizzo di tecnologie di cui non si ha piena esperienza e conoscenza, soprattutto le tecnologie legate al Cloud Computing, rendendo più difficoltosa la comprensione e l’applicazione delle stesse in fase di implementazione}
