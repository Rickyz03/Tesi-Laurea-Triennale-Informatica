...
% PDF libraries
\addtocategory{web}{site:fpdf}
\addtocategory{web}{site:pypdf2}
\addtocategory{web}{site:pdfrw}

% HTML libraries
\addtocategory{web}{site:mako}
\addtocategory{web}{site:dominate}
\addtocategory{web}{site:yattag}

% Data formats
\addtocategory{web}{site:csv}
\addtocategory{web}{site:hdf5}
\addtocategory{web}{site:npy}
\addtocategory{web}{site:parquet}
\addtocategory{web}{site:zarr}

% Cloud storage libraries
\addtocategory{web}{site:google-cloud-storage-lib}
\addtocategory{web}{site:gcsfs}

% Web development
\addtocategory{web}{site:angular}
\addtocategory{web}{site:react}
\addtocategory{web}{site:vue}
\addtocategory{web}{site:react-hook-form}
\addtocategory{web}{site:zod}
\addtocategory{web}{site:shadcn-ui}
...
% New colors for code highlighting

\definecolor{darkgreen}{RGB}{0,100,0}



% Python code highlighting with listings

% \makeatletter permette a LaTeX di interpretare correttamente il contenuto del comando multi-riga e commenti nel mezzo. Il problema era che il parser di LaTeX veniva chiuso prematuramente da un commento o da un a capo non gestito, prima che il comando \lstset venisse chiuso correttamente.
\makeatletter
\lstset{%
  language=Python,
  ...
  breaklines=true,
  frame=single,
  stringstyle=\color{darkgreen},     % stringhe
  keywordstyle=\color{blue},         % parole chiave Python
  keywordstyle=[2]\color{orange},    % funzioni e metodi noti
  keywordstyle=[3]\color{gray},      % variabili personalizzate
  morekeywords={True, False, cosine_similarity},
  morekeywords=[2]{dot, encode, groupby, to_dict, first, abs, sum, div, values, T, keys, DataFrame, index, columns, convert_to_tensor, crosstab, axis},
  morekeywords=[3]{orders_df, user_prod, item_vectors, item_sim_matrix,
    sim_abs_sum, sim_norm, R, S_norm_T, pred_vals,
    purchase_pred_matrix, sku_to_first_name, name_embeddings,
    product_product, user_item_similarityPred, user_product,
    name_list, model, PRODUCT_SKU, PRODUCT_NAME, CUSTOMER_ID, sim_name_name},
}
\makeatother
