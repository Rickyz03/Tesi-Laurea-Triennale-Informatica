...
\hypertarget{UC18.2}{}
\begin{usecase}{18.2}{Visualizzazione lista di grafiici}

\begin{figure}[!h] 
    \centering 
    \includegraphics[width=0.9\columnwidth]{usecase/UC18.2 - Visualizzazione lista di grafiici.png}
    \caption{UC18.2 - Visualizzazione lista di grafiici}
\end{figure}
