...
\newglossaryentry{babel} {
    ...
    text=Babel,
    sort=babel,
    description={transpiler JavaScript che converte codice ECMAScript moderno in versioni compatibili con browser più datati, permettendo l'uso di funzionalità JavaScript avanzate}
}
...
\newglossaryentry{jinja2} {
    ...
    text=Jinja2,
    sort=jinja2,
    description={motore di template moderno e veloce per Python, che permette di separare la logica di presentazione dal codice applicativo utilizzando una sintassi espressiva}
}
...
\newglossaryentry{dataframe} {
    ...
    text=DataFrame,
    sort=dataframe,
    description={struttura dati bidimensionale etichettata con colonne di tipi potenzialmente diversi, simile a una tabella di database o un foglio di calcolo Excel}
}
...
\newglossaryentry{zod} {
    ...
    text=Zod,
    sort=zod,
    description={libreria TypeScript per la validazione e parsing di schemi dati con inferenza automatica dei tipi, che garantisce type safety a runtime}
}
...
\newglossaryentry{shadcnui} {
    ...
    text=Shadcn/ui,
    sort=shadcnui,
    description={collezione di componenti UI riutilizzabili per React, costruiti con Radix UI e Tailwind CSS, che possono essere copiati e personalizzati nel progetto}
}

\newglossaryentry{pandasvectorizedops} {
    name=Pandas Vectorized Operations,
    text=Pandas Vectorized Operations,
...
\newglossaryentry{pandasdataframeapply} {
    ...
    description={metodo di Pandas che applica una funzione lungo un asse di un DataFrame, permettendo di trasformare i dati riga per riga o colonna per colonna}
}
...
\newglossaryentry{hook} {
    ...
    text=hook,
    sort=hook,
    description={funzioni speciali in React che permettono di utilizzare stato e altre funzionalità React all'interno di componenti funzionali, come useState e useEffect}
}
