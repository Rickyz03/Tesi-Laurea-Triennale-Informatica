...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{OO3}: implementazione di un Task AI per l’analisi di bilancio con LLM;
        \item \textbf{OO4}: generazione automatica di report con output coerente, chiaro e adattabile;
        \item \textbf{OO5}: testing e documentazione completa del prototipo.
    \end{itemize}
    \item Desiderabili:
    \begin{itemize}
    ...
    \item Opzionali:
    \begin{itemize}
        \item \textbf{OZ1}: sviluppo di una semplice interfaccia chatbot o dashboard interattiva;
