...
% A new color for code highlighting
...
\lstset{%
  ...
  morekeywords=[2]{cosine_similarity, dot, encode, groupby, to_dict, first, abs, sum, div, values, T},
  morekeywords=[3]{orders_df, user_prod, item_vectors, item_sim_matrix,
    ...
    name_list, model, PRODUCT_SKU, PRODUCT_NAME, CUSTOMER_ID}
}
\makeatother
