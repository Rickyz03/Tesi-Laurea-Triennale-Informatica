...
\addtocategory{libri}{womak:lean-thinking}
\addtocategory{articoli}{womak:serendipity-recommender-systems}
\addtocategory{libri}{womak:introduction-information-retrieval}
